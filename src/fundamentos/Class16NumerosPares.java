//Pedimos al usuario un inicio y un final.
//  Debemos mostrar los números pares entre dicho inicio y final.
//Versión 2:
//  Pediremos al usuario si desea ver PARES o IMPARES.
//de FRANCISCO GARCÍA SERRANO a todos:    4:51 PM
//Class16NumerosPares
//  Pedimos al usuario un inicio y un final./
//Debemos mostrar los números pares entre dicho inicio y final.
//Versión 2:
//  Comprobaremos que el valor inicial es menor al valor final.
//    Pediremos al usuario si desea ver PARES o IMPARES.
package fundamentos;
